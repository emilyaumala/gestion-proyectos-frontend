...
const Clientes = () => {
  ...
  useEffect(() => {
    axios
      .get("https://crm.constecoin.com/apicrm/clientes")
      .then((response) => {
  ...
  const columnas = [
    {
      ...
      ...getColumnSearchProps("tipoIdentificacion"), // Acceder a la propiedad cliente dentro del objeto cliente
      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <span>¿Está seguro de eliminar este cliente? Esta acción no se puede deshacer.</span>
          </div>
        </Modal>
      </div>
    </div>
